...
CLASSIFIER_PATH = 'okela/model/facemodels.pkl'
FACENET_MODEL_PATH = 'okela/model/20180402-114759.pb'
...
pnet, rnet, onet = detect_face.create_mtcnn(sess, "okela/align")
                ...
                while (True):
                    ...
                    if faces_found > 0:
                        ...
                        for i in range(faces_found):
                            ...
                            if (bb[i][3]-bb[i][1])/frame.shape[0]>0.1: #Remove the face too small
                                ...
                                print('index of person: ', best_class_indices[0])
